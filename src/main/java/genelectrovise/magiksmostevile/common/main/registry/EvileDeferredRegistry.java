...
//=========GENERATION==================================================================================================================
	...
	//public static final RegistryObject<ShrineFeature> SHRINE_FEATURE = FEATURES.register("shrine_overworld_gen",
	//		() -> new ShrineFeature(ShrineFeatureConfig::deserialize));
